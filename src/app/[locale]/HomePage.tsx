        ...
        <div className="container mx-auto px-4 z-10">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-heading mb-4">
              <span className="block text-neutral-800">{content.hero.title[locale]}</span>
              <span className="gradient-text">{content.hero.subtitle[locale]}</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Button
                size="lg"
                className="text-lg"
                onClick={() => analyticsEvents.navigation.ctaClick('hero_join')}
              >
                <Link href={`/${locale}/contact`}>{content.hero.cta[locale]}</Link>
              </Button>
            </div>
          </motion.div>
        </div>
