...
export function NewsletterPopup({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        runConfetti()
        // 🎯 newsletter_signup (key event) — lead capté. Aucun email envoyé à GA.
        analyticsEvents.newsletter.signup('popup')
  ...
  const getHeadlineText = () => {
    if (locale === 'fr') {
      switch (animationStage) {
        case 0:
          return "Restez à la pointe de l'investissement !"
        case 1:
          return 'Ne manquez aucune opportunité !'
        case 2:
          return "Rejoignez notre communauté d'investisseurs !"
        default:
          return "Restez à la pointe de l'investissement !"
      }
    } else {
      switch (animationStage) {
        case 0:
          return 'Stay at the forefront of investing!'
        case 1:
          return "Don't miss any opportunity!"
        case 2:
          return 'Join our investor community!'
        default:
          return 'Stay at the forefront of investing!'
      }
    }
  ...
  const getDescriptionText = () => {
    if (locale === 'fr') {
      switch (animationStage) {
        case 0:
          return "Recevez des analyses exclusives et des conseils d'experts directement dans votre boîte mail"
        case 1:
          return "Soyez informé des meilleurs événements et occasions d'investissement avant tout le monde"
        case 2:
          return 'Plus de 100 investisseurs nous font déjà confiance pour leur éducation financière'
        default:
          return "Recevez des analyses exclusives et des conseils d'experts directement dans votre boîte mail"
      }
    } else {
      switch (animationStage) {
        case 0:
          return 'Receive exclusive analysis and expert advice directly in your inbox'
        case 1:
          return 'Be informed of the best events and investment opportunities before everyone else'
        case 2:
          return 'Over 100 investors already trust us for their financial education'
        default:
          return 'Receive exclusive analysis and expert advice directly in your inbox'
      }
    }
                  ...
                  <>
                    <div className="mb-6">
                      ...
                      <AnimatePresence mode="wait">
                        ...
                        >
                          <p className="text-neutral-600">{getDescriptionText()}</p>
                        </motion.div>
                      </AnimatePresence>
                    </div>
