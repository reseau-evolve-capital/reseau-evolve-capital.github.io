...
export async function generateMetadata({ params }: BlogPageProps): Promise<Metadata> {
  ...
  const title = locale === 'en' ? 'Blog - Reseau Evolve Capital' : 'Blog - Reseau Evolve Capital'
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      {articles.length > 0 ? (
        ...
        <div className="my-16 text-center text-lg text-gray-600">{translations.noArticles}</div>
      )}
    </div>
  )
}
