      ...
      links: {
        ...
        resources: {
          ...
          items: [
            ...
            {
              href: '/?activeResource=article#resources',
              label: { fr: 'Articles', en: 'Articles' },
            },
            { href: '/?activeResource=video#resources', label: { fr: 'Vidéos', en: 'Videos' } },
            {
              href: '/?activeResource=podcast#resources',
              label: { fr: 'Podcasts', en: 'Podcasts' },
            },
          ],
        },
        membership: {
...
export const siteConfig = {
  ...
  links: {
    ...
    instagram:
      'https://www.instagram.com/evolvecapitalclub/profilecard/?igsh=MW15enR5b3ZzNzI2YQ%3D%3D',
