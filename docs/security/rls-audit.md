...
contre la stack Supabase locale le 2026-06-15 (21/21 tests verts ; + RPC
`record_attestation_ref` scopée `auth.uid()`, RT-03 / migration 037).
...
- **Policies** : `supabase/migrations/011_enable_rls_and_policies.sql`, `016_member_access_and_invitations.sql`, `020_attestation_sends.sql`, `037_attestation_ondemand_ref.sql` (RPC RT-03)
...
| `record_attestation_ref` (RPC) | authenticated          | EXECUTE   | ✅ SA membership · ⛔ membership B (42501 + 0 écriture) |  oui  |    ✅    |
